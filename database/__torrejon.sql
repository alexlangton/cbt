...
(3951,'2024-11-26 16:49:11','info','Se eliminaron 89 registros de logs',NULL,'2024-11-26 16:49:11'),
(3952,'2024-11-26 16:49:12','info','BaseController inicializado para tabla: logs',NULL,'2024-11-26 16:49:12'),
(3953,'2024-11-26 16:49:12','sql','SELECT * FROM logs WHERE tipo = \'sql\'','{\"tabla\":\"logs\",\"query_raw\":\"SELECT * FROM logs WHERE tipo = ?\",\"parametros\":[\"sql\"]}','2024-11-26 16:49:12'),
(3954,'2024-11-26 16:50:35','info','BaseController inicializado para tabla: logs',NULL,'2024-11-26 16:50:35'),
(3955,'2024-11-26 16:50:35','sql','SELECT * FROM logs WHERE tipo = \'error\'','{\"tabla\":\"logs\",\"query_raw\":\"SELECT * FROM logs WHERE tipo = ?\",\"parametros\":[\"error\"]}','2024-11-26 16:50:35'),
(3956,'2024-11-26 16:50:44','info','BaseController inicializado para tabla: logs',NULL,'2024-11-26 16:50:44'),
(3957,'2024-11-26 16:50:44','sql','SELECT * FROM logs WHERE tipo = \'error\'','{\"tabla\":\"logs\",\"query_raw\":\"SELECT * FROM logs WHERE tipo = ?\",\"parametros\":[\"error\"]}','2024-11-26 16:50:44');
...
(2,'Langton','agimeno@equinsa.es','8ae05fbff8d9b4fe1c8d1c0a773d65432a580b4f38f20525673174830e872338','5c9f05bf1323cdb762ff5aefe33659ec6d569ca124e89db2cc73cbdb781f316a',NULL),
...
-- Dump completed on 2024-11-26 16:51:51
